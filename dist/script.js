...
const textbox = document.getElementById("main-text"); // holds the text of the game
const speaker = document.getElementById("speaker-name"); // holds the name of the current speaker
const background = document.getElementById("scene-image"); // holds the background
...
function start_game() {
    let mainscreen = document.getElementById("game-intro-screen");
